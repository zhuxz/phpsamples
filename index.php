...
<head>
  ...
  <link rel="icon" type="image/png" href="AmazeUI242/assets/i/favicon.png">
  <link rel="apple-touch-icon-precomposed" href="AmazeUI242/assets/i/app-icon72x72@2x.png">
  <meta name="apple-mobile-web-app-title" content="Amaze UI" />
  <link rel="stylesheet" href="AmazeUI242/assets/css/amazeui.min.css"/>
  <link rel="stylesheet" href="AmazeUI242/assets/css/admin.css">
</head>
<body>
<!--[if lte IE 9]>
        ...
        <div class="am-panel am-panel-default">
          ...
          <div id="collapse-panel-2" class="am-in">
            <table class="am-table am-table-bd am-table-bdrs am-table-striped am-table-hover">
              ...
              <tr>
                <td class="am-text-center"><img src="AmazeUI242/assets/i/examples/admin-chrome.png" alt=""></td>
                <td>Google Chrome</td>
                <td>3,005</td>
              </tr>
              <tr>
                <td class="am-text-center"><img src="AmazeUI242/assets/i/examples/admin-firefox.png" alt=""></td>
                <td>Mozilla Firefox</td>
                <td>2,505</td>
              </tr>
              <tr>
                <td class="am-text-center"><img src="AmazeUI242/assets/i/examples/admin-ie.png" alt=""></td>
                <td>Internet Explorer</td>
                <td>1,405</td>
              </tr>
              <tr>
                <td class="am-text-center"><img src="AmazeUI242/assets/i/examples/admin-opera.png" alt=""></td>
                <td>Opera</td>
                <td>4,005</td>
              </tr>
              <tr>
                <td class="am-text-center"><img src="AmazeUI242/assets/i/examples/admin-safari.png" alt=""></td>
                <td>Safari</td>
                <td>505</td>
              </tr>
              </tbody>
...
<script src="AmazeUI242/assets/js/amazeui.ie8polyfill.min.js"></script>
<![endif]-->

<!--[if (gte IE 9)|!(IE)]><!-->
<script src="AmazeUI242/assets/js/jquery.min.js"></script>
<!--<![endif]-->
<script src="AmazeUI242/assets/js/amazeui.min.js"></script>
<script src="AmazeUI242/assets/js/app.js"></script>
